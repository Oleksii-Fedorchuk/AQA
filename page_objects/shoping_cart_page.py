...
class ShoppingCart(BasePage):
    ...
    def your_cart(self):
        return self.__your_cart

    def your_cart_text(self):
        return self.__your_cart_text

    def click_on(self, shopping_cart_item):
        return self._click(shopping_cart_item)

    def get_text(self, shopping_cart_item):
        return self.read_text(shopping_cart_item)

    def add_to_cart_button(self):
        return self.__add_to_cart_button

    def item_in_shopping_cart(self):
        return self.__item_in_shopping_cart

    def name_of_item_in_shopping_item(self):
        return self.__name_of_item_in_shopping_item

    def checkout_button(self):
        return self.__checkout_button
    ...
    def set_postal_code_input(self, postal_code_value):
    ...
    def finish_button(self):
        return self.__finish_button

    def complete_header(self):
        return self.__complete_header

    def complete_header_text(self):
        return self.__complete_header_text

    def remove_from_shopping_cart_button(self):
